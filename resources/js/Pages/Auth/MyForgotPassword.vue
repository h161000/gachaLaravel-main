        ...
        <div class="pt-6 md:px-20 px-4 bg-custom">  
            ...
            <form @submit.prevent="submit">
                <div class="mb-6">
                    ...
                    <input v-model="form.email" id="email" type="email" class="h-12 shadow-xl rounded-xl w-full border-neutral-300 focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:ring-opacity-50 rounded-md shadow-sm  placeholder-neutral-300" placeholder="例) user@raffle-pro.com"/>
