...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-neutral-600">パスワードを更新する</h2>
            <p class="mt-1 text-sm text-neutral-600">安全を確保するには、アカウントで長くてランダムなパスワードを使用するようにしてください。</p>
        </header>

        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                <InputLabel for="current_password" value="現在のパスワード"  class="text-neutral-600 pl-2" />
                <TextInput
                    id="current_password"
            ...
            <div>
                <InputLabel for="password" value="新しいパスワード"  class="text-neutral-600 pl-2"/>
                <TextInput
                    id="password"
                    ref="passwordInput"
            ...
            <div>
                <InputLabel for="password_confirmation" value="パスワードの確認" class="text-neutral-600 pl-2" />
                <TextInput
