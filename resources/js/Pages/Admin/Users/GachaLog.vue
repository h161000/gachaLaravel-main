                        ...
                        <template v-for="gacha in gachas" class="">
                            <tr class="border-r border-t border-gray-400">
                                ...
                                <td class="text-center py-2 border-r border-gray-200">
                                    <Link class="underline text-sky-600" v-if="gacha.products[0].id > 0" :href="route('admin.product', {id: gacha.products[0].id})">{{ gacha.products[0].id }}</Link>
                                </td>
                            ...
                            <tr v-for="product in gacha.products.slice(1)" class="border-r border-r-gray-400 border-t border-t-gray-200">
                                <td class="text-center py-2 border-r border-gray-200">
                                    <Link class="underline text-sky-600" v-if="product.id > 0" :href="route('admin.product', {id: product.id})">{{ product.id }}</Link>
                                </td>
