    ...
    <AdminLayout>
        <div class="mt-2">
            <div class="p-1 text-right">
                <button @click.prevent="submit()" :class="{ 'opacity-50': form.processing }" :disabled="form.processing" class="w-32 bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-normal py-2 px-3 inline-block rounded">
                    <div class="inline-block align-middle"><PaperAirplaneIcon class="w-5 h-5 mr-1"/></div> <div class="inline-block align-middle">保存</div>
                </button>
            </div>
            <div class="flex mb-1">
                <draggable class=" list-group w-full" :list="list" @change="log">
                <div
