            ...
            <div class="">
                <form @submit.prevent="submit()">
                    <table class="m-auto min-w-full text-sm font-medium">
                        <tbody class="border-t">
                            <tr class="border-b border-r border-l">
                                <td class="bg-neutral-300 px-3 py-2 whitespace-nowrap  border-r w-32">カテゴリー</td>
                                <td class="font-light p-1 whitespace-nowrap">
                                    <input v-model="new_form.title" type="text" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg  block px-2 py-1.5 w-full focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:ring-opacity-50" placeholder="" required />
                    ...
                    <div class="text-center py-2">
                        <button type="submit" class="w-32 bg-neutral-500 hover:bg-neutral-700 text-white text-sm font-normal py-2 px-5  rounded">
                            登録
                        </button>
                    </div>
                </form>
                ...
                <div class="flex mb-1">
                    <draggable class="w-full list-group" :list="categories.data" @change="log">
                        <div
                            ...
                            <div class="inline-block align-middle h-full flex items-center z-10 gap-1">
