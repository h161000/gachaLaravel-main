        ...
        <div class="md:px-1 px-2 pt-4">
            ...
            <form @submit.prevent="submit()">
                ...
                <div class="mb-6">
                    ...
                    <VueDatePicker v-model="form.expiration" format="Y年 M月 d日 HH:mm"></VueDatePicker>
                ...
                <div class="mb-6">
                    <label  for="user_limit" class="block font-medium text-sm text-neutral-700 mb-2 ml-1">枚数 (半角数字) <span class="text-red-500">*</span></label>
