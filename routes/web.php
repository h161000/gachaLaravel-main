...
Route::group(['prefix'=>'admin', 'middleware' => 'user-access:admin'], function(){
    ...
    Route::get('/delivery/csv_get', [DeliveryController::class, 'csv_delivery_get'])->name('admin.delivery.csv_get');
...
Route::group(['prefix'=>'admin', 'middleware' => 'user-access:staff'], function(){
    ...
    Route::delete('/gacha/product/destroy/{id}',[GachaController::class,'product_destroy'])->name('admin.gacha.product.destroy');
    ...
    Route::delete('/product/destroy/{id}',[ProductController::class,'product_destroy'])->name('admin.product.destroy');
});
