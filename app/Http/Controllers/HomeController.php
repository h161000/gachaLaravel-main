...
class HomeController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        $gachas = Gacha::where('category_id', $cat_id)->where('status', 1)->whereRaw('(ISNULL(end_time) || end_time>NOW())')->orderBy('order_level', 'DESC')->orderBy('id', 'DESC')->get();
    ...
    public function maintenance() {
        ...
        return inertia('Maintenance', ['hide_cat_bar' => 1]);
    }
}
